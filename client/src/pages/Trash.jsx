...
const Trash = () => {
  ...
  const deleteAllClick = () => {
    setType("deleteAll");
    setMsg("Are you sure you want to permanently delete all items?");
    setOpenDialog(true);
  };

  const restoreAllClick = () => {
    setType("restoreAll");
    setMsg("Are you sure you want to restore all deleted tasks?");
    setOpenDialog(true);
  };
  ...
  const restoreClick = (id) => {
    setSelected(id);
    setType("restore");
    setMsg("Do you want to restore the selected items?");
    setOpenDialog(true);
  };
      ...
      <div className='w-full md:px-1 px-0 mb-6'>
        ...
        {data?.tasks?.length > 0 ? (
          ...
          <div className='w-full flex justify-center py-10'>
            <p className='text-lg text-purple-500'>Trash is empty.</p>
          </div>
        )}
      </div>
